...
<%
    ...
    try {
         ResultSet rs1 = st1.executeQuery("SELECT * FROM user_reg where email='" + mail + "' AND password='" + pass + "'");
        ...
        if (rs.next()) {
            ...
            response.sendRedirect("User_login.jsp?Not_Approved");
        }
                }
                else {
            response.sendRedirect("User_login.jsp?Authentication_Failed");
        }
